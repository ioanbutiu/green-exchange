	...
	return (
		<div className="container-fluid p-0">
			...
			<main className="">
				...
				<ImageWide {...imageWide} />
				<div className="container-fluid pt-3 pb-5 pt-md-5 pb-md-3 bg-light" style={{ overflow: 'hidden' }}>
					<div
						...
						<span
							...
							style={{ fontSize: '120px', lineHeight: '1', whiteSpace: 'nowrap', margin: '0rem 2rem' }}>
