			...
			<main className="">
				...
				<div className="container py-5">
					...
					{iconRow && (
						<div className="row">
							{iconRow.map((icon) => (
								<div key={icon._key} className="col-3 mt-4 px-3 position-relative">
									<div
										className="d-flex justify-content-between align-items-center my-4 pe-4"
										style={{ marginLeft: '-5%' }}>
										<img src={urlFor(icon.icon)} className="" style={{ width: '60%' }}></img>
										<img src={urlFor(icon.symbol)} className="" style={{}}></img>
									</div>
									<h6 className="display-6 d-block pt-4">{icon.heading}</h6>
									<p>{icon.text}</p>
								</div>
							))}
						</div>
				...
				<ImageWide {...imageWide} />
				<div className="container-fluid py-5 bg-light" style={{ overflow: 'hidden' }}>
					<div
